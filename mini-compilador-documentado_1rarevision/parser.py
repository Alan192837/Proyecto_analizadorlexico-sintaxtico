...
def p_lista_sentencias_error_recuperado(p):
    """lista_sentencias : lista_sentencias error PUNTOCOM"""
    # Recuperación de error: cuando un enunciado es inválido, PLY descarta
    # tokens hasta encontrar ';' y aplica esta regla, conservando los
    # enunciados válidos ya acumulados en p[1].
    p[0] = p[1]

def p_lista_sentencias_primer_error(p):
    """lista_sentencias : error PUNTOCOM"""
    # Recuperación cuando el primer enunciado es inválido: empieza con lista vacía.
    p[0] = []
